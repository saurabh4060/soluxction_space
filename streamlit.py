...
if f1 is not None:
    ...
    os.chdir("https://drive.google.com/file/d/1KAbVFKQwQXPYY9K1LLVPjahSgdzSMIGT/view?usp=drive_link")
    df= pd.read_csv("https://drive.google.com/file/d/1KAbVFKQwQXPYY9K1LLVPjahSgdzSMIGT/view?usp=drive_link")
